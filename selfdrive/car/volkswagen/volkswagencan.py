...
def create_mqb_acc_control(packer, bus, acc_status, apply_accel, standstill, idx):
  values = {
    ...
    "ACC_zul_Regelabw_unten": 1.0 if acc_status == 3 else 0,  # FIXME: need comfort regulation logic here
    "ACC_zul_Regelabw_oben": 1.0 if acc_status == 3 else 0,  # FIXME: need comfort regulation logic here
