...
def create_mqb_acc_control(packer, bus, acc_status, apply_accel, idx):
  values = {
    ...
    "ACC_zul_Regelabw_unten": 0.5 if acc_status == 3 else 0,  # FIXME: need comfort regulation logic here
    "ACC_zul_Regelabw_oben": 0.5 if acc_status == 3 else 0,  # FIXME: need comfort regulation logic here
