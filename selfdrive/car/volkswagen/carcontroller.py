...
class CarController():
  ...
  def update(self, enabled, CS, frame, actuators, visual_alert, audible_alert, leftLaneVisible, rightLaneVisible):
    ...
    if frame % P.HCA_STEP == 0:
      ...
      can_sends.append(volkswagencan.create_steering_control(self.packer_pt, CANBUS.pt, apply_steer,
                                                                 idx, hcaEnabled))
    ...
    if frame % P.LDW_STEP == 0:
      ...
      can_sends.append(volkswagencan.create_hud_control(self.packer_pt, CANBUS.pt, hcaEnabled,
    ...
    if CS.graMsgBusCounter != self.graMsgBusCounterPrev:
      ...
      if self.graButtonStatesToSend is not None:
        ...
        can_sends.append(volkswagencan.create_acc_buttons_control(self.packer_pt, self.acc_bus, self.graButtonStatesToSend, CS, idx))
