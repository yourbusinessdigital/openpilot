...
ECU_SOFTWARE_VERSION_REQUEST = bytes([uds.SERVICE_TYPE.READ_DATA_BY_IDENTIFIER]) + \
  p16(uds.DATA_IDENTIFIER_TYPE.VEHICLE_MANUFACTURER_ECU_SOFTWARE_VERSION_NUMBER)
ECU_SOFTWARE_VERSION_RESPONSE = bytes([uds.SERVICE_TYPE.READ_DATA_BY_IDENTIFIER + 0x40]) + \
  p16(uds.DATA_IDENTIFIER_TYPE.VEHICLE_MANUFACTURER_ECU_SOFTWARE_VERSION_NUMBER)
...
REQUESTS = [
  ...
  # Volkswagen
  (
    [EXTENDED_DIAGNOSTIC_REQUEST, ECU_SOFTWARE_VERSION_REQUEST],
    [EXTENDED_DIAGNOSTIC_RESPONSE, ECU_SOFTWARE_VERSION_RESPONSE]
  )
]
